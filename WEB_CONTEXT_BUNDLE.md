...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-234-erd-s-problem-234-9aeaa4b3-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-234"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-234-erd-s-problem-234-9aeaa4b3-v1",
      "problem_contract_sha256": "2820effb5240937f7d9f757696a10b9badabf6d56aa24f5f1d4f3b91da91d46e",
      "problem_id": "problem:um-ep-234-erd-s-problem-234-9aeaa4b3",
      "route_id": "route:um-ep-234-erd-s-problem-234-9aeaa4b3-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-234-erd-s-problem-234-9aeaa4b3-source-fidelity-01",
      "graph_id": "graph:um-ep-234-erd-s-problem-234-9aeaa4b3-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-234-erd-s-problem-234-9aeaa4b3-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-234-erd-s-problem-234-9aeaa4b3-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "For every $c\\geq 0$ the density $f(c)$ of integers for which $ \\frac{p_{n+1}-p_n}{\\log n}< c $ exists and is a continuous function of $c$. \", \"difficulty\": \"L1\" },{"
          },
          "statement_sha256": "b1b74c580bb346d9b1f015477956c44e27a61636cd1503d211e491d8589c7bfd"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-234-erd-s-problem-234-9aeaa4b3-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-234-erd-s-problem-234-9aeaa4b3-root",
      "route_id": "route:um-ep-234-erd-s-problem-234-9aeaa4b3-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-234-a0466495abc5",
        "url": "https://www.unsolvedmath.com/problems/EP-234"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
